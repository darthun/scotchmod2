...
public class WashbackScreen extends AbstractContainerScreen<WashbackMenu> {
    //start
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ScotchMod.MOD_ID,"textures/gui/mash_tun_gui.png");


    //end
    private FluidTankRenderer fluidTankRenderer;
    public WashbackScreen(WashbackMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
